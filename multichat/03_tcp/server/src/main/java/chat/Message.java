                                ...
                                java.io.Serializable
{
    ...
    public Message(String id, String sender, String receiver, String content, boolean isAudio, long timestamp)
    {
        this.id = id;
        this.sender = sender;
    ...
    public boolean equals(java.lang.Object rhs)
    {
        ...
        if(r != null)
        {
            ...
            if(this.receiver != r.receiver)
            {
                if(this.receiver == null || r.receiver == null || !this.receiver.equals(r.receiver))
                {
                    return false;
                }
            }
    ...
    public int hashCode()
    {
        ...
        h_ = com.zeroc.IceInternal.HashUtil.hashAdd(h_, receiver);
        h_ = com.zeroc.IceInternal.HashUtil.hashAdd(h_, content);
        h_ = com.zeroc.IceInternal.HashUtil.hashAdd(h_, isAudio);
    ...
    /** @hidden */
    public static final long serialVersionUID = 250723800244354218L;
}
